\input{/home/rfpc/modproject/xelatex/commands.tex}
...
\cmidrule(rl){5-6}
\cmidrule(rl){1-4}
\multicolumn{4}{l'}{} & \textbf{جمع ناخالص}  & \zs & \textbf{جمع کسورات }& \zt\\
\cmidrule(rl){7-8}
\cmidrule(rl){1-6}
\multicolumn{6}{r'}{\small{مبلغ قابل پرداخت به حروف: \zu}} & \textbf{مانده} & \textbf{\zv}\\
\end{tabular}
\end{mdframed}
\end{normalsize}
\end{center}
